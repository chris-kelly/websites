...
@media screen and (min-width: 673px) {
	...
	.content-sidebar {float: left;margin-left: -45.5%;padding: 48px 30px 24px;position: relative;width: 33.33333333%;}
}
...
@media screen and (min-width: 1008px) {
    ...
    .site:before {width: 0;z-index: -20;display: none;}
   	#secondary { background-color: transparent;border: 0;clear: none;float: right;margin: 0 0 0 -100%;}
}
@media screen and (min-width: 1080px) {
    .site:after {width: 222px;}
